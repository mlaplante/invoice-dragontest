      ...
      <View>
        ...
        <View style={styles.billing__section}>
          <View>
            ...
            {clientName && (
              <Text style={[styles.text, { fontFamily: 'Poppins-Bold', fontSize: 14 }]}>
                {clientName}
              </Text>
            )}
          ...
          {rows.map(({ id, description, details, rate, quantity, amount }) => (
            <View style={styles.invoice_item} key={id}>
              <View style={styles.des__group}>
                ...
                <Text style={{ fontSize: '10', opacity: 0.8, width: '95%', minWidth: '80%' }}>
                  {details}
                </Text>
              </View>
              <Text style={[styles.col__colour1, { width: '20%', textAlign: 'center' }]}>
                {quantity}
              </Text>
